  ...
  <div class="page-body">
    ...
    <div class="summary-section">
      <div class="summary-card entries">
        <div class="summary-icon" style="color:#4A7FA7">
      ...
      <div class="summary-card last">
        <div class="summary-icon" style="color:#0A8C74">
      ...
      <div class="summary-card blood">
        <div class="summary-icon" style="color:#EF4444">
          <i class="fa-solid fa-link"></i>
        </div>
        <div class="summary-info">
          <div class="summary-label">Accès dossier</div>
          <div class="summary-value">
            <a href="dossier.php" style="color:inherit;text-decoration:none">Ouvrir</a>
          </div>
        </div>
      </div>
    </div>

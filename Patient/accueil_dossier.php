...
<head>
  ...
  <title>Dossier patient — Accueil</title>
...
<main class="main-content">
  ...
  <div class="topbar">
    ...
    <div class="topbar-left">
      <h1 class="page-title">Dossier patient</h1>
  ...
  <div class="page-body">
    ...
    <!-- Résultats + Jour de passage (exemples / démo) -->
...
<script>
  // Démo: données locales. Tu pourras remplacer par BD plus tard.
  const entries = [
    {
